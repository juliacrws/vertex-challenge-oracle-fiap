...
with DAG(
    ...
    # Aguarda a execução diária mais recente da Speed Layer (DAG separada,
    ...
    aguardar_speed_layer = ExternalTaskSensor(
        task_id="aguardar_speed_layer",
        external_dag_id="pipeline_vertex_speed",
        external_task_id="transformacao_cnes_speed_layer",
        mode="reschedule",
        timeout=60 * 30,
        poke_interval=60,
    )
